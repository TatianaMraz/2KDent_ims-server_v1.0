...
from core.views import TableViewSet, TableHeadViewSet, ProductViewSet, ProductUpdateAPIView, ProductChoicesViewSet, \
    OrderViewSet, OrderUpdateAPIView, OrderItemViewSet, OrderUnitChoicesViewSet
...
urlpatterns = [
    ...
    path('order-unit-choices/', OrderUnitChoicesViewSet.as_view({'get': 'list'}), name='order-unit-choices'),
]
